    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse((move || {
                Result::<_, ()>::Ok(crate::api::simple::decrypt(api_key, api_ciphertext))
            })())
        },
    )
}
fn wire_encrypt_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || {
                Result::<_, ()>::Ok(crate::api::simple::encrypt(api_key, api_message))
            })())
        },
    )
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        2 => wire_decrypt_impl(ptr, rust_vec_len, data_len),
        3 => wire_encrypt_impl(ptr, rust_vec_len, data_len),
